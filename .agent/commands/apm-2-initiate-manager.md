...
# APM 0.6.0-token-efficient – Manager Agent Initiation Prompt
...
- **Spec Audit Slash Command**: When the user triggers `/apm-spec-audit <task_id>`, read .apm/guides/Validator_Prompt.md and perform the audit immediately.
