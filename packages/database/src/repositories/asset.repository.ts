...
import type { Asset, CreateAssetInput, UpdateAssetInput } from '@moondesk/domain';
...
export class AssetRepository implements IAssetRepository {
    ...
    async getByIdWithSensors(id: number, organizationId: string): Promise<Asset | null> {
        ...
        const sensorResults = await this.db
            .select()
            .from(sensors)
            .where(and(eq(sensors.assetId, id), eq(sensors.organizationId, organizationId)));
