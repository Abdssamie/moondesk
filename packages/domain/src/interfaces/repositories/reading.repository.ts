...
export interface IReadingRepository {
     ...
     */
    getRecent(organizationId: string, sensorId: number, limit?: number): Promise<Reading[]>;
     ...
     */
    getLatestBySensor(organizationId: string, sensorIds: number[]): Promise<Map<number, Reading>>;
