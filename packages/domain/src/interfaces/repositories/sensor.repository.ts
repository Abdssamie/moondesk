import type { Sensor, CreateSensorInput, UpdateSensorInput } from '../../models/sensor';
...
export interface ISensorRepository {
     ...
     */
    update(id: number, organizationId: string, input: UpdateSensorInput): Promise<Sensor | null>;
