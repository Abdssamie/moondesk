...
export interface IConnectionCredentialRepository {
     ...
     */
    getByProtocol(protocol: Protocol, organizationId: string): Promise<ConnectionCredential[]>;

    /**
     * Get a single credential by ID
     */
    getById(id: number, organizationId: string): Promise<ConnectionCredential | null>;
     ...
     */
    update(id: number, organizationId: string, input: UpdateCredentialInput): Promise<ConnectionCredential | null>;
