import type { Command, CreateCommandInput, UpdateCommandStatusInput } from '../../models/command';
...
export interface ICommandRepository {
     ...
     */
    updateStatus(id: number, organizationId: string, input: UpdateCommandStatusInput): Promise<Command | null>;
}
