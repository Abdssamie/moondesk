...
- Pass control back to the .agent/workflows/Setup_Agent_Initiation_Prompt.md logic.
- **Context Recovery:** When generating the Bootstrap Prompt, you must use the **EXACT TEMPLATE** from .agent/workflows/Setup_Agent_Initiation_Prompt.md. If the template is degraded or missing from your context window, **READ .agent/workflows/Setup_Agent_Initiation_Prompt.md** to retrieve it before generating the final artifact.
