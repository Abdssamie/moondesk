...
- **Format:** Use the exact template provided in your .agent/workflows/Implementation_Agent_Initiation_Prompt.md instructions.
...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.agent/workflows/Debug_Delegation_Guide.md or .agent/workflows/Research_Delegation_Guide.md)]
```
...
- **Debug Delegation**: Reference .agent/workflows/Debug_Delegation_Guide.md
- **Research Delegation**: Reference .agent/workflows/Research_Delegation_Guide.md  
